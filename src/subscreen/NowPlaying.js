...
const NowPlaying = (props) => {
   ...
   //apiKey = "53939b3da3d575c42c212fb77c52c5a5";
    ...
    // const getMovies = (url) => {
    //     setIsLoading(true);
    //     axios.get(`https://api.themoviedb.org/3/movie/now_playing?api_key=53939b3da3d575c42c212fb77c52c5a5&language=en-US&page=${currentPage}`)
    //         .then(res => {
    ...
    return (
        <View>
            ...
            {/* <View>
                <BannerAd
                    unitId={"ca-app-pub-2031920793825769/6381476252"}
