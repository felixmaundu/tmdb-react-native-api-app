...
const Popular = props => {
    ...
    // const getMovies = (url) => {
    //     setIsLoading(true);
    //     axios.get(`https://api.themoviedb.org/3/movie/popular?api_key=53939b3da3d575c42c212fb77c52c5a5&language=en-US&page=${currentPage}`)
    //         .then(res => {
    ...
    const getMovies = () => {
        const apiURL = `https://api.themoviedb.org/3/movie/popular?api_key=53939b3da3d575c42c212fb77c52c5a5&page=${currentPage}`;
        fetch(apiURL)
    ...
    return (
        <View>
            ...
            {/* <View>
                <BannerAd
                    unitId={"ca-app-pub-2031920793825769/6764619636"}
